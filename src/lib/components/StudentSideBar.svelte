<script>
  ...
  const menuItems = [
    ...
    { name: 'Available Projects', href: '/student/projects' },
    { name: 'My Projects', href: '/student/myprojects' },
    { name: 'Horarios', href: '/student/horarios' },
    { name: 'Perfil', href: '/student/perfil' },
  ];
