<script>
  ...
  function openToggleModal(event, row) {
    ...
    confirmModal = {
      open: true,
      eyebrow: 'Security confirmation',
      title: nextIsActive ? 'Enable teacher access?' : 'Disable teacher access?',
      message: nextIsActive
        ? 'This teacher will be able to access the platform again.'
        : 'This teacher will temporarily lose access to the platform.',
      details: row.nombre,
