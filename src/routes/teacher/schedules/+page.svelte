<script>
  ...
  function handleAction() {
    alert('This action requires full integration with the schedules or deliverables backend.');
  }
</script>
    ...
    <section class="list-section">
      <div class="section-title">
        <div>
          ...
          <p>Information obtained from the API for teacher consultation.</p>
        </div>
        ...
        {#each projects as project}
          <article class="project-card">
            ...
            <div class="card-actions">
              ...
              <button class="enroll-btn" type="button" onclick={handleAction}>
                View details
              </button>
            </div>
          </article>
